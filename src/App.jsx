...
Rules:
- Only approve expenses explicitly listed as qualifying reliefs under LHDN YA${ya}
...
- If partially claimable, suggest only the qualifying portion
...
If not claimable: {"claimable":false,"category_id":null,"category_name":null,"total_amount":0,"suggested_amount":0,"explanation":"Reason why not.","conditions":null}`;
    ...
    userContent.push({
      type: "text",
      text: desc ? `User describes the expense as: "${desc}". ${scanImg ? "A receipt image is also attached." : "No receipt image provided."}` : "A receipt image has been attached. Analyze it."
    });
